...
* `PEP-685 Comparison of extra names for optional distribution dependencies <https://www.python.org/dev/peps/pep-0622/>`__
...
it for development purposes using ``pip install -e .``.
